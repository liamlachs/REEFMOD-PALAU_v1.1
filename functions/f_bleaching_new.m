...
function [coral, genes, algal, total_coral_loss, total_mortality] = f_bleaching_new(coral, genes, algal, bleaching_whole_mortality,...
    CORAL, doing_3D, nb_coral_types, doing_clades, doing_DHWbleaching, doing_genetics, bleaching_whole_offset, bleaching_partial_offset,Topt_baseline, Topt2index)
...
[coral_cm2, surface_cm2, volume_cm3, clade, heat_tolerance, colony_ID, species_ID] = f_struct_deploy (coral);
...
[coral] = f_struct_rebuild (coral_cm2, surface_cm2, volume_cm3, colony_ID, clade, heat_tolerance, species_ID, nb_coral_types, doing_clades, doing_DHWbleaching, doing_3D);
